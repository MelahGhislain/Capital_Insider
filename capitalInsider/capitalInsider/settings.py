"""
Django settings for capitalInsider project.
...
SECRET_KEY = 'django-insecure-p9iv0^wbkhh3sehd*r0l+cvuxrbw(f&#j!!7n&x$j1n**^0&1u'
...
ROOT_URLCONF = 'capitalInsider.urls'
...
WSGI_APPLICATION = 'capitalInsider.wsgi.application'
